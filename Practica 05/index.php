              ...
              <table>
                <thead>
                  <tr>
                    ...
                    <th width="250">Acciòn 1</th>
                    <th width="250">Acción 2</th>
                  </tr>
                </thead>
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><a href="./Delete.php?ID=<?php echo $user['ID']; ?>" class="button radius tiny secondary">Delete</a></td>
                  </tr>
                  <?php } ?>
                  <tr>
